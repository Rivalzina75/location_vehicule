...
<div class="dashboard-wrapper-pro">
    ...
    <aside class="sidebar-pro">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="#" class="menu-item" data-page="catalogue">
                <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a href="#" class="menu-item" data-page="reservations">
                <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a href="#" class="menu-item" data-page="inspection">
                <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a href="{{ route('logout') }}" class="logout-btn"
               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                </svg>
            </a>
    ...
    <main class="main-content-pro">
        ...
        <div class="page-content active" id="home">
            <div class="page-header">
                ...
                <button class="btn-primary" onclick="navigateTo('catalogue')">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <div class="two-column-layout">
                ...
                <div class="column-left">
                    ...
                    <div class="card-pro">
                        ...
                        <div class="quick-actions-grid">
                            <button class="action-card-pro" onclick="navigateTo('catalogue')">
                            ...
                            <button class="action-card-pro" onclick="navigateTo('reservations')">
                                <div class="action-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke-width="2"/>
                                        <path d="M16 2v4M8 2v4M3 10h18" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                            ...
                            <button class="action-card-pro" onclick="navigateTo('documents')">
                                <div class="action-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <button class="action-card-pro" onclick="navigateTo('inspection')">
                                <div class="action-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <div class="card-pro">
                        <div class="card-header">
                            ...
                            <a href="#" class="link-text">{{ __('Tout voir') }} →</a>
                        </div>
                ...
                <div class="column-right">
                    ...
                    <div class="card-pro">
                        ...
                        <button class="btn-secondary" onclick="navigateTo('reservations')">
        ...
        <!-- CATALOGUE PAGE (À implémenter) -->
        <div class="page-content" id="catalogue">
            <div class="page-header">
                <h1 class="page-title">{{ __('Catalogue de véhicules') }}</h1>
            </div>
            <p>{{ __('Contenu à venir...') }}</p>
        </div>

        <!-- RESERVATIONS PAGE (À implémenter) -->
        <div class="page-content" id="reservations">
            <div class="page-header">
        ...
        <!-- DOCUMENTS PAGE (À implémenter) -->
        <div class="page-content" id="documents">
            <div class="page-header">
                <h1 class="page-title">{{ __('Documents') }}</h1>
            </div>
            <p>{{ __('Contenu à venir...') }}</p>
        </div>

        <!-- INSPECTION PAGE (À implémenter) -->
        <div class="page-content" id="inspection">
            <div class="page-header">
                <h1 class="page-title">{{ __('Inspection') }}</h1>
            </div>
            <p>{{ __('Contenu à venir...') }}</p>
        </div>

        <!-- PROFILE PAGE (À implémenter) -->
